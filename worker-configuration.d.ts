/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 869625fb0515a2b9cecffd185664d3d7)
// Runtime types generated with workerd@1.20260507.1 2025-04-15 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DB: D1Database;
		ASSETS: Fetcher;
		ENCRYPTION_KEY: "PLEASE_SET_IN_WEBFLOW_CLOUD_DASHBOARD";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENCRYPTION_KEY" | "WEBFLOW_API_HOST" | "WEBFLOW_SITE_API_TOKEN" | "WEBFLOW_CMS_SITE_API_TOKEN">> {}
}
