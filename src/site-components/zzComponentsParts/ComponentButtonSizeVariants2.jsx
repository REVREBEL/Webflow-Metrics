...
export function ComponentButtonSizeVariants2(
    {
    ...
    const _styleVariantMap = {
        "XS": "w-variant-ee812636-c6bf-32cb-5178-471c3b2d996e",
        "SM": "w-variant-ee812636-c6bf-32cb-5178-471c3b2d996f",
        "Base": "",
        "MD": "w-variant-ee812636-c6bf-32cb-5178-471c3b2d9970",
        "LG": "w-variant-ee812636-c6bf-32cb-5178-471c3b2d9971",
        "XL": "w-variant-ee812636-c6bf-32cb-5178-471c3b2d9972"
    };

    const _activeStyleVariant = _styleVariantMap[optionsButtonSizeVariants];

    return (
        <_Component className={`div-block-726 ${_activeStyleVariant}`} tag="div"><_Builtin.Block
                className={`component_button-size-variants-2 ${_activeStyleVariant}`}
                tag="div">{buttonVisibility ? <_Builtin.Link
                    className={`buton_variant-2 ${_activeStyleVariant}`}
                    button={true}
                    id={buttonId}
                    block=""
                    options={buttonLink}>{buttonButtonText}</_Builtin.Link> : null}{iconsTurnIconVisibilityOn ? <_Builtin.Block className={`icon_spacer-3 ${_activeStyleVariant}`} tag="div" /> : null}{iconsTurnIconVisibilityOn ? <_Builtin.Block className={`icon_size-variant-3 ${_activeStyleVariant}`} tag="div">{iconsImageIcon ? <_Builtin.Block
