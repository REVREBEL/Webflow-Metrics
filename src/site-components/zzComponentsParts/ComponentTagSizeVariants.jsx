...
export function ComponentTagSizeVariants(
    {
    ...
    const _styleVariantMap = {
        "XS": "w-variant-016c3f6e-321b-9879-1eac-66f794cdd835",
        "SM": "w-variant-016c3f6e-321b-9879-1eac-66f794cdd836",
        "RG": "",
        "MD": "w-variant-016c3f6e-321b-9879-1eac-66f794cdd837",
        "LG": "w-variant-016c3f6e-321b-9879-1eac-66f794cdd838",
        "XL": "w-variant-016c3f6e-321b-9879-1eac-66f794cdd839"
    };
    ...
    return (
        <_Component
            className={`component_base-4 component_tag-contanier ${_activeStyleVariant}`}
            tag="div"><_Builtin.Block
                className={`component_tag-size-variants ${_activeStyleVariant}`}
                tag="div"><_Builtin.Block className={`tag_text-variant ${_activeStyleVariant}`} tag="div">{buttonButtonText}</_Builtin.Block>{iconsTurnIconVisibilityOn ? <_Builtin.Block className={`icon_spacer ${_activeStyleVariant}`} tag="div" /> : null}{iconsTurnIconVisibilityOn ? <_Builtin.Block className={`icon_size-variant ${_activeStyleVariant}`} tag="div">{iconsImageIcon ? <_Builtin.Block className={`component-icon_visibility ${_activeStyleVariant}`} tag="div">{iconsImageIcon ? <_Builtin.Image
